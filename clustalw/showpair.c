...
*/
	...
	for (i=0;i<5;i++)
	   accum[i]=(int*)ckfree((void *)accum[i]);
	accum=(int**)ckfree((void *)accum);

	displ=(int*)ckfree((void *)displ);
	slopes=(char*)ckfree((void *)slopes);
	diag_index=(int*)ckfree((void *)diag_index);

	zza=(int*)ckfree((void *)zza);
	zzb=(int*)ckfree((void *)zzb);
	zzc=(int*)ckfree((void *)zzc);
	zzd=(int*)ckfree((void *)zzd);
}
